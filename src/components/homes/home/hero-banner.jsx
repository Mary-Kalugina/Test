               ...
               <div className="row">
                  <div className="col-xl-6 col-lg-6 col-md-8">
                     <div className="hero-content">
                        <span>Acquire Fresh Expertise and Explore Trending Courses</span>
                        <h2 className="hero-title mb-35">For Every Student, Every <i>Classroom</i>.</h2>
                        <p>For every learner, in every corner of the digital classroom, E-Pora Online Learning offers boundless opportunities for growth and discovery. Join us on your educational journey today!</p>
