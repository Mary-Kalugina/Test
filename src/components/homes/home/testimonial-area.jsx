...
const testimonial_data = [
  {
    ...
    des: (
      <>
        As an aspiring UX/UI Designer, E-Pora Online Learning has been invaluable. The courses are clear, engaging, and have prepared me for a successful career.
      </>
    ),
  },
  {
    ...
    des: (
      <>
        E-Pora Online Learning has equipped me with the essential skills and knowledge I need to excel in my career as a Software Engineer.
      </>
    ),
  },
  {
    ...
    des: (
      <>
        Thanks to E-Pora Online Learning, my writing skills have skyrocketed, and I've gained valuable insights into content strategy and SEO, setting me up for success as a Content Writer.
      </>
    ),
  },
  {
