               ...
               <div className="col-lg-8 col-md-12">
                  <div className="c-details-wrapper mr-25">
                     ...
                     <div className="c-details-about mb-40">
                        ...
                        <p>This course is a comprehensive and professional learning experience designed for those aspiring to become experts in web design and user interface (UI/UX) using Adobe XD. This course is tailored for both beginners and more experienced designers, providing a thorough coverage of all aspects of creating outstanding web projects.</p>
                        <p>Throughout this masterclass, you will immerse yourself in the world of modern web design and not only learn the fundamentals of Adobe XD but also advanced techniques and strategies employed by professionals in UI/UX design. Through hands-on lessons and projects, you will discover how to craft effective and creative user interfaces that meet the needs of today's users and enhance their interaction with web applications. Regardless of your experience level, this course equips you with all the tools and knowledge necessary to become a master of web design using Adobe XD.</p>
                     </div>
                     <div className="cor-details-instructor mb-40">
                        ...
                        <p>"As the course instructor, I'm delighted to witness the impressive growth of my students in this course. It's fulfilling to see them apply UI/UX principles effectively in Adobe XD, transforming creative ideas into user-focused web designs. Their dedication and the quality of their projects are truly commendable. This course equips them with valuable skills and empowers them to excel in the dynamic field of web design. I'm excited to witness their ongoing success in the design community."</p>
                     </div>
